...
1.  **The Server (`index.js`):**
    This file just keeps the server running on port 3001. It waits for someone (using `curl` or a frontend website) to send a request saying "I want to move tokens."
